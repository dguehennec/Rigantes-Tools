...
com.rigantestools.Options.init = function() {
    ...
    this._util.setAttribute("rigantestools-optionDefenseSpearman", "value", this._util.getPref(com.rigantestools_Constant.PREF_NB_MIN_SPEARMAN_DEFENSE));
    this._util.setAttribute("rigantestools-optionDefenseCrossbowman", "value", this._util.getPref(com.rigantestools_Constant.PREF_NB_MIN_CROSSBOWMAN_DEFENSE));
    this._util.setAttribute("rigantestools-optionDefenseScorpionRider", "value", this._util.getPref(com.rigantestools_Constant.PREF_NB_MIN_SCORPIONRIDER_DEFENSE));
    this._util.setAttribute("rigantestools-optionNotificationNewMessage", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_MESSAGE));
    this._util.setAttribute("rigantestools-optionNotificationNewAllianceMessage", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_ALLY_MESSAGE));
    this._util.setAttribute("rigantestools-optionNotificationNewReport", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_REPORT));
    this._util.setAttribute("rigantestools-optionNotificationAttaque", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_ATTACK));
    this._util.setAttribute("rigantestools-optionNotificationHabitatesMissions", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_MISSION_DONE));
    this._util.setAttribute("rigantestools-optionNotificationHabitatesTransits", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_TRANSIT_DONE));
    this._util.setAttribute("rigantestools-optionNotificationUnitOrder", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_UNIT_DONE));
    this._util.setAttribute("rigantestools-optionNotificationKnowledgeOrder", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_KNOWLEDGE_DONE));
    this._util.setAttribute("rigantestools-optionNotificationBuildingOrder", "checked", this._util.getPref(com.rigantestools_Constant.PREF_NOTIFICATION_BUILDING_DONE));
    this._util.setAttribute("rigantestools-optionAccessStatusBar", "checked", this._util.getPref(com.rigantestools_Constant.PREF_ACCESS_STATUSBAR));
    this._util.setAttribute("rigantestools-optionXLSExportFormat", "checked", this._util.getPref(com.rigantestools_Constant.PREF_XLS_EXPORT_FORMAT));
    this.currentCastlesArea = this._util.getPref(com.rigantestools_Constant.PREF_CASTLES_AREA);
    this.currentWarTimeArea = this._util.getPref(com.rigantestools_Constant.PREF_TIME_AREA);
...
com.rigantestools.Options.save = function() {
    ...
    this._util.setPref(com.rigantestools_Constant.PREF_NB_MIN_SPEARMAN_DEFENSE, Number(nbMinSpearman));
    this._util.setPref(com.rigantestools_Constant.PREF_NB_MIN_CROSSBOWMAN_DEFENSE, Number(nbMinCrossbowman));
    this._util.setPref(com.rigantestools_Constant.PREF_NB_MIN_SCORPIONRIDER_DEFENSE, Number(nbMinScorpionRider));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_MESSAGE, this._util.getAttribute("rigantestools-optionNotificationNewMessage", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_ALLY_MESSAGE, this._util.getAttribute("rigantestools-optionNotificationNewAllianceMessage", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_REPORT, this._util.getAttribute("rigantestools-optionNotificationNewReport", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_NEW_ATTACK, this._util.getAttribute("rigantestools-optionNotificationAttaque", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_MISSION_DONE, this._util.getAttribute("rigantestools-optionNotificationHabitatesMissions", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_TRANSIT_DONE, this._util.getAttribute("rigantestools-optionNotificationHabitatesTransits", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_UNIT_DONE, this._util.getAttribute("rigantestools-optionNotificationUnitOrder", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_KNOWLEDGE_DONE, this._util.getAttribute("rigantestools-optionNotificationKnowledgeOrder", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_NOTIFICATION_BUILDING_DONE, this._util.getAttribute("rigantestools-optionNotificationBuildingOrder", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_ACCESS_STATUSBAR, this._util.getAttribute("rigantestools-optionAccessStatusBar", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_XLS_EXPORT_FORMAT, this._util.getAttribute("rigantestools-optionXLSExportFormat", "checked"));
    this._util.setPref(com.rigantestools_Constant.PREF_CASTLES_AREA, this.currentCastlesArea);
    this._util.setPref(com.rigantestools_Constant.PREF_TIME_AREA, this.currentWarTimeArea);
    this._util.notifyObservers(com.rigantestools_Constant.OBSERVER.REFRESH);
    window.close();
};
