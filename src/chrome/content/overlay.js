...
com.rigantestools.Main.init = function() {
    /** @private */
    /** The logger. */
    this._logger = new com.rigantestools_Logger("Main");
    this._logger.trace("init");
    /** @private */
    /** The util tool. */
    this._util = new com.rigantestools_Util(window);
    this._util.addObserver(this, com.rigantestools_Constant.OBSERVER.REFRESH);
    /** @private */
    /** The mainFrame parameters when necessary. */
    this._mainFrameParameters = null;

    // add controller listener
    com.rigantestools_Controller.connect(this);
...
com.rigantestools.Main.release = function() {
    if (this._util) {
        ...
        this._util.removeObserver(this, com.rigantestools_Constant.OBSERVER.REFRESH);
        // remove controller listener
        com.rigantestools_Controller.disconnect(this);
    }
};
...
com.rigantestools.Main.observe = function(subject, topic, data) {
    if (topic === com.rigantestools_Constant.OBSERVER.REFRESH) {
        this.refresh();
    }
};
...
com.rigantestools.Main.checkVersion = function() {
    var lastversion = this._util.getPref(com.rigantestools_Constant.PREF_CURRENT_VERSION);
    if (lastversion === "") {
...
com.rigantestools.Main.refresh = function() {
    ...
    if (window.statusbar.visible && this._util.getPref(com.rigantestools_Constant.PREF_ACCESS_STATUSBAR)) {
    ...
    var nbUnreadMessages = com.rigantestools_Controller.getNbUnreadMessage();
    if (com.rigantestools_Controller.getDocument() && (nbUnreadMessages > 0)) {
    ...
    if (com.rigantestools_Controller.getDocument()) {
        this.setIcon(1);
    } else {
        this.setIcon(0);
...
com.rigantestools.Main.setIcon = function(value) {
    if (this._util.getPref(com.rigantestools_Constant.PREF_ACCESS_STATUSBAR)) {
 ...
 * @param {Object}
 *            parameters the parameters used by the MainFrame to initialize display
...
com.rigantestools.Main.showMainFrame = function(selectedTab, parameters) {
    ...
    if (!com.rigantestools_Controller.isInitialized()) {
...
com.rigantestools.Main.contentLoaded = function(evt) {
    ...
    if (evt.originalTarget instanceof HTMLDocument) {
        ...
        if ((doc.location !== null) && this.checkWebSite(doc)) {
            com.rigantestools_Controller.lordAndKnightsInterfaceLoaded(this, doc);
            this.refresh();
...
com.rigantestools.Main.contentUnload = function(evt) {
    ...
    com.rigantestools_Controller.lordAndKnightsInterfaceUnloaded(this);
    // update events listener
    window.document.addEventListener("DOMContentLoaded", this.contentLoadedEvent);
