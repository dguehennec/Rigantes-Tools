 ...
 *            parent
 */
com.rigantestools.service.InterfaceMapping = function(parent) {
    this._logger = new com.rigantestools.service.Logger("InterfaceMapping");
    /** @private */
    this._util = new com.rigantestools.service.Util();
    /** @private */
    /** The v1 interface. */
    this._interfaceV1 = new com.rigantestools.service.InterfaceMappingV1(this);
    /** @private */
    /** The v2 interface. */
    this._interfaceV2 = new com.rigantestools.service.InterfaceMappingV2(this);
    /** @private */
    /** The notifier. */
    this._notifier = new com.rigantestools.service.Notifier(this);
    /** @private */
 ...
 * @this {InterfaceMapping}
 */
com.rigantestools.service.InterfaceMapping.prototype.reset = function() {
    this._currentInterface = null;
    // reset interfaces
 ...
 * @this {InterfaceMapping}
 */
com.rigantestools.service.InterfaceMapping.prototype.release = function() {
 ...
 */
com.rigantestools.service.InterfaceMapping.prototype.isInitialized = function() {
 ...
 */
com.rigantestools.service.InterfaceMapping.prototype.getNotifier = function() {
 ...
 */
com.rigantestools.service.InterfaceMapping.prototype.getPlayer = function(type) {
 ...
 */
com.rigantestools.service.InterfaceMapping.prototype.isPlayerProfileSelected = function() {
    if (this.isInitialized()) {
 ...
 * @return {Boolean} true if selected
 */
com.rigantestools.service.InterfaceMapping.prototype.isReportDescriptionSelected = function() {
    if (this.isInitialized()) {
 ...
 * @return {Boolean} true if selected
 */
com.rigantestools.service.InterfaceMapping.prototype.isOwnInformationsSelected = function() {
    if (this.isInitialized()) {
 ...
 * @return {Boolean} true if selected
 */
com.rigantestools.service.InterfaceMapping.prototype.copyAttackReport = function() {
    if (this.isInitialized()) {
 ...
 * @return {Boolean} true if selected
 */
com.rigantestools.service.InterfaceMapping.prototype.copyProfile = function() {
    try {
        var index;
        var province;
