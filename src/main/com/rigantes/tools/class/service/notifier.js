 ...
 * @this {Notifier}
 */
com.rigantestools.service.Notifier = function(parent) {
    /** @private */
    /** The logger. */
    this._logger = new com.rigantestools.service.Logger("Notifier");
    /** @private */
    /** The util tool. */
 ...
 * @this {Notifier}
 */
com.rigantestools.service.Notifier.prototype.start = function() {
 ...
 * @this {Notifier}
 */
com.rigantestools.service.Notifier.prototype.stop = function() {
 ...
 * @this {Notifier}
 */
com.rigantestools.service.Notifier.prototype.refresh = function() {
 ...
 */
com.rigantestools.service.Notifier.prototype.setDefaultValue = function(player) {
    this._player = player;
 ...
 */
com.rigantestools.service.Notifier.prototype.getNbUnreadMessage = function() {
 ...
 *            player the player refreshed
 */
com.rigantestools.service.Notifier.prototype.check = function(player) {
    // check player
    var nbAttaque = player.habitatisAttacked - this._player.habitatisAttacked;
    if (nbAttaque > 0 && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_NEW_ATTACK)) {
    ...
    if (nbMessages > 0 && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_NEW_MESSAGE)) {
        if (nbMessages === 1) {
    ...
    if (nbReport > 0 && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_NEW_REPORT)) {
        if (nbReport === 1) {
    ...
    if (nbMessagesAlliance > 0 && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_NEW_ALLY_MESSAGE)) {
    ...
    for ( var index = 0; index < habitates.length; index++) {
        ...
        if (currentHabitat !== null) {
            if (habitat.nbhabitatesMissions < currentHabitat.nbhabitatesMissions && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_MISSION_DONE)) {
            ...
            if (habitat.nbhabitatesTransits < currentHabitat.nbhabitatesTransits && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_TRANSIT_DONE)) {
            ...
            if (habitat.nbUnitOrder < currentHabitat.nbUnitOrder && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_UNIT_DONE)) {
            ...
            if (habitat.nbKnowledgeOrder < currentHabitat.nbKnowledgeOrder && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_KNOWLEDGE_DONE)) {
            ...
            if (habitat.nbHabitatBuildingOrder < currentHabitat.nbHabitatBuildingOrder && this._util.getPref(com.rigantestools.constant.PREF_NOTIFICATION_BUILDING_DONE)) {
 ...
 */
com.rigantestools.service.Notifier.prototype.getcurrentHabitat = function(id) {
