 ...
 * @this {Util}
 */
com.rigantestools.service.Util = function() {
 ...
 */
com.rigantestools.service.Util.prototype.getWindow = function(doc) {
    if (doc === null) {
        return null;
    }
...
/** @private bundle */
com.rigantestools.service.Util.prototype._bundle = null;
 ...
 */
com.rigantestools.service.Util.prototype.getBundleString = function(param) {
    try {
        if (com.rigantestools.service.Util.prototype._bundle === null) {
            com.rigantestools.service.Util.prototype._bundle = document.getElementById("rigantestools-bundle");
        }
        return com.rigantestools.service.Util.prototype._bundle.getString(param);
    } catch (e) {
        return '';
    }
};
 ...
 */
com.rigantestools.service.Util.prototype.getPref = function(pref) {
 ...
 */
com.rigantestools.service.Util.prototype.setPref = function(pref, value) {
    try {
        var prefManager = Components.classes["@mozilla.org/preferences-service;1"].getService(Components.interfaces.nsIPrefBranch);
 ...
 */
com.rigantestools.service.Util.prototype.isNumeric = function(sText, decimals, negatives) {
    var isNumber = true;
    var numDecimals = 0;
 ...
 */
com.rigantestools.service.Util.prototype.valideHabitatLink = function(link) {
 ...
 * @return {boolean} true if a good link.
 */
com.rigantestools.service.Util.prototype.validePlayerLink = function(link) {
 ...
 * @return {boolean} true if a good link.
 */
com.rigantestools.service.Util.prototype.valideAllianceLink = function(link) {
 ...
 * @return {boolean} true if a good link.
 */
com.rigantestools.service.Util.prototype.valideReportLink = function(link) {
...
com.rigantestools.service.Util.prototype.valideTimeHHMM = function(time, twentyHoursMax) {
    var reg = new RegExp("[0-9]{2}:[0-5][0-9]", "g");
    if (!reg.test(time)) {
        return false;
    }
 ...
 */
com.rigantestools.service.Util.prototype.secToTimeStr = function(time) {
    if (time === null) {
        return "";
    }
 ...
 */
com.rigantestools.service.Util.prototype.formatDateTime = function(date) {
    if (date === null) {
        return "";
    }
    ...
    var a = com.rigantestools.service.Util.prototype.getBundleString("smallDay." + day);
 ...
 */
com.rigantestools.service.Util.prototype.formatDayTime = function(date) {
    if (date === null) {
        return "";
    }
 ...
 */
com.rigantestools.service.Util.prototype.formatShortDateTime = function(date) {
    if (date === null) {
        return "";
    }
 ...
 * @return {string} date in format jj.mm.aaaa.
 */
com.rigantestools.service.Util.prototype.maxStringLength = function(name, length) {
 ...
 */
com.rigantestools.service.Util.prototype.openURL = function(UrlToGoTo) {
    try {
 ...
 * @return {boolean} true of successful.
 */
com.rigantestools.service.Util.prototype.copieToClipboard = function(text) {
 ...
 */
com.rigantestools.service.Util.prototype.getXULWindow = function(id) {
 ...
 *            callback
 */
com.rigantestools.service.Util.prototype.showNotificaton = function(title, text, callbackData, callback) {
    try {
 ...
 */
com.rigantestools.service.Util.prototype.saveContentToFile = function(title, filename, data) {
    try {
        var nsIFilePicker = Components.interfaces.nsIFilePicker;
        var fp = Components.classes["@mozilla.org/filepicker;1"].createInstance(nsIFilePicker);
        fp.init(window, title, nsIFilePicker.modeSave);
        fp.appendFilter(com.rigantestools.service.Util.prototype.getBundleString("export.type.file") + " CSV", "*.csv");
 ...
 * @return {boolean} true if success
 */
com.rigantestools.service.Util.prototype.saveContentToXLSFile = function(filename, data) {
    try {
        ...
        window.location.href = uri + window.btoa(unescape(encodeURIComponent(template.replace(/{(\w+)}/g, function(m, p) {
            return ctx[p];
        }))));
        return true;
    } catch (e) {
 ...
 */
com.rigantestools.service.Util.prototype.printContent = function(data) {
    try {
 ...
 */
com.rigantestools.service.Util.prototype.installButton = function(toolbarId, id, afterId) {
 ...
 */
com.rigantestools.service.Util.prototype.setVisibility = function(id, visibility) {
 ...
 * @return {Boolean} true if success
 */
com.rigantestools.service.Util.prototype.setAttribute = function(id, attribute, value) {
    try {
        var element = window.document.getElementById(id);
 ...
 */
com.rigantestools.service.Util.prototype.getAttribute = function(id, attribute) {
    var element = window.document.getElementById(id);
    if (element) {
        if (attribute === 'currentIndex') {
 ...
 */
com.rigantestools.service.Util.prototype.removeAttribute = function(id, attribute) {
    var element = window.document.getElementById(id);
    if (element) {
 ...
 *            message the message
 */
com.rigantestools.service.Util.prototype.showMessage = function(title, message) {
    window.openDialog('chrome://rigantestools/content/message.xul', "", 'chrome, modal, dialog, centerscreen', title, message);
};
 ...
 */
com.rigantestools.service.Util.prototype.showOption = function(selectedTab) {
    window.openDialog('chrome://rigantestools/content/options.xul', "", 'chrome, modal, dialog, centerscreen', selectedTab);
};
 ...
 * @this {Util}
 */
com.rigantestools.service.Util.prototype.showAbout = function() {
    window.openDialog('chrome://rigantestools/content/about.xul', this.getBundleString("about.about.label"), 'chrome, modal, dialog, centerscreen');
};
 ...
 */
com.rigantestools.service.Util.prototype.showMainFrame = function(main) {
    return window.openDialog('chrome://rigantestools/content/mainFrame.xul', '', 'chrome,centerscreen,resizable,dialog=no', main);
};
 ...
 *            topic the topic
 */
com.rigantestools.service.Util.prototype.addObserver = function(observer, topic) {
 ...
 *            topic the topic
 */
com.rigantestools.service.Util.prototype.removeObserver = function(observer, topic) {
    var observerService = Components.classes["@mozilla.org/observer-service;1"].getService(Components.interfaces.nsIObserverService);
 ...
 *            data the data
 */
com.rigantestools.service.Util.prototype.notifyObservers = function(topic, data) {
    var observerService = Components.classes["@mozilla.org/observer-service;1"].getService(Components.interfaces.nsIObserverService);
 ...
 * @this {Util}
 */
com.rigantestools.service.Util.prototype.JSONToDOM = function(xml, doc, nodes) {
    ...
    function tag(name, attr) {
        ...
        args.forEach(function(e) {
            elem.appendChild(typeof e == "object" ? tag.apply(null, e) : e instanceof Node ? e : doc.createTextNode(e));
        });
        return elem;
    }
