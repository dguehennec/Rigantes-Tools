 ...
 */
com.rigantestools.domain.Player = function(mplayer, worldID) {
    this._logger = new com.rigantestools.service.Logger("Player");
 ...
 */
com.rigantestools.domain.Player.prototype.init = function(mplayer) {
    try {
        ...
        for ( var sProp in mhabitate) {
            if (mhabitate.hasOwnProperty(sProp)) {
                var habitat = new com.rigantestools.domain.Habitat(mhabitate[sProp], this.world);
 ...
 */
com.rigantestools.domain.Player.prototype.getHabitatList = function() {
